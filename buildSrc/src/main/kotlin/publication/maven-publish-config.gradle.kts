...
publishing {
    publications {
        withType<MavenPublication>().all {
            val projectGitUrl = "https://github.com/Merseyside/android-filemanager"
            artifact(tasks.named<Jar>("withSourcesJar"))
            artifact(javadocJar)
            pom {
                name.set("Mersey android file manager")
                description.set("Allows easily communicate with file storage")
